 ...
 * ============================================================================================== */
TransMenu.spacerGif = "style/1x1.gif";                     // path to a transparent spacer gif
TransMenu.dingbatOn = "style/1x1.gif";            // path to the active sub menu dingbat
TransMenu.dingbatOff = "style/1x1.gif";          // path to the inactive sub menu dingbat
...
TransMenu.shadowColor = "#0F327B";                        // color of shadow (transparency is set in CSS)
TransMenu.shadowPng = "style/grey-40.png";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#DCE4F3";                   // color of the background (transparency set in CSS)
TransMenu.backgroundPng = "style/white-90.png";          // a PNG graphic to server as the background for mac IE5
