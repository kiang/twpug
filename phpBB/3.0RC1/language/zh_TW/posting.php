...
$lang = array_merge($lang, array(
	'ADD_ATTACHMENT'			=> '上傳附件',
	'ADD_ATTACHMENT_EXPLAIN'	=> '如果您要上傳附件，請在下面填寫詳細資訊',
	'ADD_FILE'					=> '新增檔案',
	'ADD_POLL'					=> '建立投票',
	'ADD_POLL_EXPLAIN'			=> '如果您不想在話題中新增投票，請不要填寫以下內容',
	'ALREADY_DELETED'			=> '對不起，此內容已經被刪除。',
	'ATTACH_QUOTA_REACHED'		=> '對不起，您的附件限額已經用完了。',
	'ATTACH_SIG'				=> '新增簽名（簽名可以在會員控制面板修改）',

	'BBCODE_A_HELP'				=> '行內顯示附件: [attachment=]filename.ext[/attachment]',
	...
	'GENERAL_UPLOAD_ERROR'		=> '無法上傳附件到 %s',
	...
	'LOGIN_EXPLAIN_BUMP'		=> '您需要登入後才能在這個版面推舉話題。',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> 'Flash檔案的高度不允許超過 %1$d 象素。',
	'MAX_FLASH_WIDTH_EXCEEDED'	=> 'Flash檔案的寬度不允許超過 %1$d 象素。',
	'MAX_IMG_HEIGHT_EXCEEDED'	=> '圖片的高度不允許超過 %1$d 象素。',
	'MAX_IMG_WIDTH_EXCEEDED'	=> '圖片的寬度不允許超過 %1$d 象素。',
	...
	'PHP_SIZE_NA'				=> '要上傳的附件太大了。<br />無法獲知 php.ini 中設定的最大允許上傳檔案大小。',
	'PHP_SIZE_OVERRUN'			=> '要上傳的附件太大了，php.ini 中設定的最大允許上傳檔案大小為 %d MB。<br />請注意這個數值是在 php.ini 內設定的，無法被覆蓋。',
	'PLACE_INLINE'				=> '置入文中',
	'POLL_DELETE'				=> '刪除投票',
	'POLL_FOR'					=> '投票持續時間',
	...
	'POLL_TITLE_COMP_TOO_LONG'	=> '解析後的投票標題過長, 請刪除一些BBCode或表情圖標.',
	'POLL_VOTE_CHANGE'			=> '允許重新投票',
	'POLL_VOTE_CHANGE_EXPLAIN'	=> '如果允許，會員將可以更改他們的選擇。',
	'POSTED_ATTACHMENTS'		=> '發佈的附件',
	...
	'STYLES_TIP'				=> '提示：點選格式選項可以將格式直接應用到選中的文字上',

	'TOO_FEW_CHARS'				=> '您輸入的正文過短',
	'TOO_FEW_POLL_OPTIONS'		=> '您必須輸入至少兩個投票選項',
	'TOO_MANY_ATTACHMENTS'		=> '不能再新增更多的附件了，允許的數量是 %d 個。',
	...
	'UNGLOBALISE_EXPLAIN'		=> '要將這個主題從全局公告轉換為普通主題，您需要選擇一個版面放置它。',
	'UPDATE_COMMENT'			=> '更新評論',
	...
	'USER_CANNOT_FORUM_POST'	=> '您不能在這個版面進行發帖操作，因為這個版面類型不支援。',

	'VIEW_MESSAGE'				=> '%s檢視您提供的內容%s',

	'WRONG_FILESIZE'			=> '檔案太大了, 最大允許檔案尺寸為 %1d %2s',
	'WRONG_SIZE'				=> '圖片必須最小寬 %1$d 象素，高 %2$d 象素；最大寬 %3$d 象素，高 %4$d 象素。您提供的圖片為：寬 %5$d 象素，高 %6$d 象素。',
));
