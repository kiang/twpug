...
$lang = array_merge($lang, array(
	...
	'BACK_TO_TOP' => '頁首',
	'BACK_TO_PREV' => '回到前一頁',
	'BAN_TRIGGERED_BY_EMAIL' => '被停用的原因是您的信箱位址。',
	'BAN_TRIGGERED_BY_IP' => '被停用的原因是您的IP位址。',
	'BAN_TRIGGERED_BY_USER' => '被停用原因是您的帳號。',
	'BBCODE_GUIDE' => 'BBCode使用手冊',
	'BCC' => 'BCC',
	'BIRTHDAYS' => '生日',
	'BOARD_BAN_PERM' => '您被這個討論區<strong>永遠</strong>停用。<br /><br />請聯繫 %2$s討論區管理員3$s 以取得更多資訊。',
