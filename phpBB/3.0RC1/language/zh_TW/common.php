...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_DEACTIVATED'			=> '您的帳號已經被凍結, 並且只有管理員才能重新啟用.',
	'ACCOUNT_NOT_ACTIVATED'			=> '您的帳號尚未被啟用',
	'ACP'							=> '管理員控制面板',
	'ACTIVE'						=> '啟用',
	'ACTIVE_ERROR'					=> '您指定了一個未被啟用的帳號，請啟用您的帳號後再試一次。如果還是有問題請聯繫討論區管理員。',
	'ADMINISTRATOR'					=> '管理員',
	'ADMINISTRATORS'				=> '管理員',
	'AGE'							=> '年齡',
	'AIM'							=> 'AIM',
	...
	'ALL_TOPICS'					=> '全部主題',
	'AND'							=> '和',
	'ARE_WATCHING_FORUM'			=> '您訂閱了這個版面，版面更新時將向您發送消息。',
	'ARE_WATCHING_TOPIC'			=> '您訂閱了這個主題，主題更新時將向您發送消息。',
	'ASCENDING'						=> '升冪',
	'ATTACHMENTS'					=> '附件',
	'ATTACHED_IMAGE_NOT_IMAGE'		=> '您附加的圖片檔案是無效的.',
	'AUTHOR'						=> '作者',
	'AUTH_NO_PROFILE_CREATED'		=> '建立會員資料失敗',
	'AVATAR_DISALLOWED_EXTENSION'	=> '副檔名 %s 已經被停用',
	'AVATAR_EMPTY_REMOTE_DATA'		=> '圖示無法上傳，遠端的資料無效或損壞。',
	'AVATAR_EMPTY_FILEUPLOAD'		=> '上傳的圖示檔案是空的.',
	'AVATAR_INVALID_FILENAME'		=> '%s 是無效的檔案名稱',
	'AVATAR_NOT_UPLOADED'			=> '圖示無法上傳。',
	'AVATAR_NO_SIZE'				=> '無法獲得圖示的長和寬，請手動輸入合適的數值。',
	'AVATAR_PARTIAL_UPLOAD'			=> '上傳的檔案只上傳了一部分',
	'AVATAR_PHP_SIZE_NA'			=> '圖示檔案太大。<br />無法判斷伺服器PHP允許的最大檔案大小。',
	'AVATAR_PHP_SIZE_OVERRUN'		=> '圖示檔案太大，伺服器允許的最大檔案大小是 %d MB。<br />請注意這個由php.ini設定所以無法更改。',
	'AVATAR_URL_INVALID'			=> '指定的連結無效。',
	'AVATAR_URL_NOT_FOUND'			=> '無法找到指定的檔案。',
	'AVATAR_WRONG_FILESIZE'			=> '圖示檔案大小必須在 0 和 %1d %2s 之間。',
	'AVATAR_WRONG_SIZE'				=> '圖示的寬度要大於 %1$d 象素，高度要大於 %2$d 象素 並且寬度不能超過 %3$d 象素，高度不能超過 %4$d 象素。您提供的圖示寬為 %5$d 象素，高為 %6$d 象素。',

	'BACK_TO_TOP'			=> '頁首',
	'BACK_TO_PREV'			=> '回到前一頁',
	'BAN_TRIGGERED_BY_EMAIL'=> '被停用的原因是您的email地址。',
	'BAN_TRIGGERED_BY_IP'	=> '被停用的原因是您的IP地址。',
	'BAN_TRIGGERED_BY_USER'	=> '被停用原因是您的帳號。',
	'BBCODE_GUIDE'			=> 'BBCode使用手冊',
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> '生日',
	'BOARD_BAN_PERM'		=> '您被這個討論區<strong>永遠</strong>停用。<br /><br />請聯繫 %2$s討論區管理員3$s 以得到更多的資訊。',
	'BOARD_BAN_REASON'		=> '被停用的原因: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> '您在 <strong>%1$s</strong> 之前將被禁止瀏覽討論區。<br /><br />請聯繫 %2$s討論區管理員 %3$s 以得到更多資訊。',
	'BOARD_DISABLE'			=> '很抱歉本討論區暫時關閉',
	'BOARD_DISABLED'		=> '本討論區暫時關閉',
	'BOARD_UNAVAILABLE'		=> '很抱歉本討論區暫時無法使用，請過幾分鐘再登入',
	'BROWSING_FORUM_GUEST'	=> '正在瀏覽此版面的會員：%1$s 和 %2$d 位遊客',
	'BROWSING_FORUM_GUESTS'	=> '正在瀏覽此版面的會員：%1$s 和 %2$d 位遊客',
	'BYTES'					=> 'Bytes',
	...
	'CONFIRM'				=> '確認',
	'CONFIRM_CODE'			=> '確認碼',
	'CONFIRM_CODE_EXPLAIN'	=> '輸入您在圖片中看到的字元，不需要區分大小寫。請注意沒有零。',
	...
	'EMAIL_SMTP_ERROR_RESPONSE'			=> '發送email遇到問題 <strong>Line %1$s</strong>。Response: %2$s',
	...
	'ERR_UNABLE_TO_LOGIN'				=> '登入錯誤。提供的帳號或密碼錯誤。',
	...
	'FORUM_LOCKED'			=> '版面鎖定',
	'FORUM_RULES'			=> '版面規則',
	'FORUM_RULES_LINK'		=> '請點選閱讀討論區規則',
	'FROM'					=> '自',
	'FSOCK_DISABLED'		=> '操作無法完成，因為fsock函數被停用或者無法找到目標伺服器。',

	'FTP_FSOCK_HOST'				=> 'FTP 主機',
	'FTP_FSOCK_HOST_EXPLAIN'		=> '用於連接您的網站的FTP 伺服器',
	'FTP_FSOCK_PASSWORD'			=> 'FTP 密碼',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> '對應您的FTP帳號的密碼',
	'FTP_FSOCK_PORT'				=> 'FTP 連接埠',
	'FTP_FSOCK_PORT_EXPLAIN'		=> '您的FTP伺服器的連接埠',
	'FTP_FSOCK_ROOT_PATH'			=> '到 phpBB 的路徑',
	...
	'GUEST'						=> '遊客',
	'GUEST_USERS_ONLINE'		=> '共有 %d 位遊客在線上',
	'GUEST_USERS_TOTAL'			=> '%d 位遊客',
	'GUEST_USERS_ZERO_ONLINE'	=> '共有 0 位遊客在線上',
	'GUEST_USERS_ZERO_TOTAL'	=> '0 位遊客',
	'GUEST_USER_ONLINE'			=> '共有 %d 位遊客在線上',
	'GUEST_USER_TOTAL'			=> '%d 位遊客',
	'G_ADMINISTRATORS'			=> '管理員',
	'G_BOTS'					=> '機器人',
	'G_GUESTS'					=> '遊客',
	'G_REGISTERED'				=> '註冊會員',
	'G_REGISTERED_COPPA'		=> '註冊COPPA會員',
	'G_GLOBAL_MODERATORS'		=> '討論區版主',

	'HIDDEN_USERS_ONLINE'		=> '%d 位隱身會員在線上',
	'HIDDEN_USERS_TOTAL'		=> '%d 位隱身會員和 ',
	'HIDDEN_USERS_ZERO_ONLINE'	=> '0 位隱身會員在線上',
	'HIDDEN_USERS_ZERO_TOTAL'	=> '0 位隱身會員和 ',
	'HIDDEN_USER_ONLINE'		=> '%d 位隱身會員在線上',
	...
	'IF'						=> '如果',
	'IMAGE'						=> '圖片',
	'IMAGE_FILETYPE_INVALID'	=> '不支援圖片檔案類型 %d for mimetype %s 。',
	'IMAGE_FILETYPE_MISMATCH'	=> '圖片檔案類型不符合: 需要的副檔名是 %1$s 但是給的是 %2$s。',
	'IN'						=> '位於',
	'INDEX'						=> '首頁',
	'INFORMATION'				=> '資訊',
	'INTERESTS'					=> '興趣',
	'INVALID_DIGEST_CHALLENGE'	=> '無效的 digest challenge',
	'INVALID_EMAIL_LOG'			=> '<strong>%s</strong> 是無效的email地址?',
	'IP'						=> 'IP',
	'IP_BLACKLISTED'			=> '您的 IP %1$s 已經被封鎖。要得到更多的資訊請查閱 <a href="%2$s">%2$s</a>。',
	...
	'LOCATION'							=> '地址',
	'LOCK_POST'							=> '鎖定文章',
	'LOCK_POST_EXPLAIN'					=> '阻止編輯',
	'LOCK_TOPIC'						=> '鎖定主題',
	'LOGIN'								=> '登入',
	'LOGIN_CHECK_PM'					=> '登入並檢查私人信件',
	'LOGIN_CONFIRMATION'				=> '登入確認',
	'LOGIN_CONFIRM_EXPLAIN'				=> '為了防止暴力破解會員密碼，討論區管理員要求您在超過最大嘗試次數後輸入一組確認碼。確認碼顯示在以下所示的圖片中。如果您存在視力缺陷無法閱讀請聯繫 %s討論區管理員%s。',
	...
	'NEVER'						=> '從未',
	'NO'						=> '否',
	'NOT_ALLOWED_MANAGE_GROUP'	=> '您不能從管理員控制面板管理這個群組。',
	'NOT_AUTHORISED'			=> '您沒有權限瀏覽這塊區域.',
	'NOT_WATCHING_FORUM'		=> '您已經取消這個版面的訂閱，版面更新資訊停止發送。',
	...
	'NO_TOPICS_TIME_FRAME'		=> '在選定的時間段中這個版面沒有主題發表。',
	'NO_UNREAD_PM'				=> '<strong>0</strong> 未讀簡訊',
	'NO_UPLOAD_FORM_FOUND'		=> '上傳初始化結束但是沒有有效的檔案上傳資料表。',
	'NO_USER'					=> '請求的會員不存在。',
	'NO_USERS'					=> '請求的會員不存在。',
	...
	'POST_BY_AUTHOR'		=> '由',
	'POST_BY_FOE'			=> '這篇文章由 <strong>%1$s</strong> 發表，他/她正在您的忽略列表中。%2$s顯示這篇文章%3$s。',
	'POST_DAY'				=> '每天 %.2f 篇文章',
	'POST_DETAILS'			=> '文章細節',
	...
	'READING_TOPIC'				=> '檢視主題在 %s',
	'READ_PROFILE'				=> '會員資料',
	'REASON'					=> '原因',
	'RECORD_ONLINE_USERS'		=> '最高在線上記錄：<strong>%1$s</strong>，發生於 %2$s',
	'REDIRECT'					=> '重定向',
	'REDIRECTS'					=> '總共轉向',
	'REGISTER'					=> '註冊',
	...
	'REMOVE'					=> '刪除',
	'REMOVE_INSTALL'			=> '在開始使用討論區前請刪除、移除或重命名 install 資料夾。如果這個資料夾存在，您只能瀏覽管理員控制面板(ACP)。',
	'REPLIES'					=> '回覆總數',
	...
	'RETURN_TO'					=> '回到',
	'RULES_ATTACH_CAN'			=> '您 <strong>可以</strong> 在這個版面提供附件',
	'RULES_ATTACH_CANNOT'		=> '您 <strong>不能</strong> 在這個版面提供附件',
	'RULES_DELETE_CAN'			=> '您 <strong>可以</strong> 在這個版面刪除文章',
	'RULES_DELETE_CANNOT'		=> '您 <strong>不能</strong> 在這個版面刪除文章',
	'RULES_DOWNLOAD_CAN'		=> '您 <strong>可以</strong> 在這個版面下載附件',
	'RULES_DOWNLOAD_CANNOT'		=> '您 <strong>不能</strong> 在這個版面下載附件',
	...
	'RULES_VOTE_CAN'			=> '您 <strong>可以</strong> 在這個版面發起投票',
	'RULES_VOTE_CANNOT'			=> '您 <strong>不能</strong> 在這個版面發起投票',
	...
	'SORRY_AUTH_VIEW_ATTACH'	=> '您沒有下載這個附件的權限',
	'SORT_BY'					=> '排序',
	'SORT_JOINED'				=> '加入時間',
	'SORT_LOCATION'				=> '地址',
	'SORT_RANK'					=> '級別',
	...
	'TOO_LONG_EMAIL'				=> '您輸入的 email 地址太長了。',
	'TOO_LONG_EMAIL_CONFIRM'		=> '您輸入的 email 驗證地址太長了。',
	'TOO_LONG_WEBSITE'				=> '您輸入的網站地址太長了。',
	...
	'TOO_SHORT_EMAIL'				=> '您輸入的 email 地址太短了。',
	'TOO_SHORT_EMAIL_CONFIRM'		=> '您輸入的 email 驗證地址太短了。',
	'TOO_SHORT_WEBSITE'				=> '您輸入的網站地址太短了。',
	...
	'TOTAL_LOG'			=> '1 個記錄',
	'TOTAL_LOGS'		=> '%d 個記錄',
	'TOTAL_NO_PM'		=> '總計 0 個私人簡訊',
	'TOTAL_PM'			=> '總計 1 個私人簡訊',
	'TOTAL_PMS'			=> '總計 %d 個私人簡訊',
	'TOTAL_POSTS'		=> '發表文章總數',
	...
	'UNREAD_PM'				=> '<strong>%d</strong> 條未讀簡訊',
	'UNREAD_PMS'			=> '<strong>%d</strong> 條未讀簡訊',
	'UNWATCHED_FORUMS'		=> '您將不再關注這些選中的版面。',
	'UNWATCHED_TOPICS'		=> '您將不再關注這些選中的主題。',
	'UPDATE'				=> '更新',
	...
	'WRONG_DATA_WEBSITE'		=> '網站的地址無效，請包含協定前綴。例如 http://www.phpbbchina.com/。',
	...
	'YOU_NEW_PM'		=> '您的收件夾中有一條新簡訊',
	'YOU_NEW_PMS'		=> '您的收件夾中有數條新簡訊',
