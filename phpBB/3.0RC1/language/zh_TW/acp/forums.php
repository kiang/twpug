...
$lang = array_merge($lang, array(
	...
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> '一旦建立, 這個版面將行使您選擇的版面同樣的權限. 如果沒有選中, 新的版面在權限設定前將是無法見的.',
	'COPY_PERMISSIONS_EDIT_EXPLAIN'	=> '如果您選擇了複製權限, 版面將行使您選擇的版面同樣的權限. 這將覆蓋您原先設定的權限. 如果沒有選中, 將保留原有權限.',
	'CREATE_FORUM'					=> '建立新版面',
	...
	'DISPLAY_ACTIVE_TOPICS_EXPLAIN'		=> '如果設定為是, 在選中的子版面中熱門的文章將會顯示在這個分區下.',
	...
	'ENABLE_TOPIC_ICONS'			=> '允許主題圖標',

	'FORUM_ADMIN'						=> '版面管理',
	'FORUM_ADMIN_EXPLAIN'				=> '在phpBB3中沒有分區, 所有都是基於版面. 每個版面可以擁有無限的子版面, 並且您可以設定哪些能發帖哪些不能. (例如是否表現為分區). 這裡您能新增, 編輯, 刪除, 鎖定, 解鎖各個版面並設定一些額外控制. 如果您的文章和主題統計失去同步, 您可以重新統計一下版面.',
	...
	'FORUM_IMAGE'						=> '版面圖標',
	'FORUM_IMAGE_EXPLAIN'				=> '和版面關聯的圖標地址, 使用討論區根目錄的相對路徑.',
	...
	'MOVE_POSTS_NO_POSTABLE_FORUM'	=> '您選中移動的目標版面無法發表文章. 請選擇其他的版面.',
	'MOVE_POSTS_TO'		=> '移動文章到',
