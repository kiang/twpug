...
$help = array(
	...
	array(
		0 => '什麼是 BBCode?',
		1 => 'BBCode是一種特殊的HTML實現方式. 您能否在文章中使用BBCode由管理員設定. 此外您可以在發表的時候設定文章是否使用BBCode. BBCode本身和HTML相似, 標籤由方括號[和]封裝而不是 &lt; 和 &gt; 並且它能提供更多的顯示控制. 取決於您使用的模板, 您會發現在發佈文章的過程中使用可點選的界面新增BBCode非常容易. 即使如此, 以下的內容對您還是很有用的.'
	),
	array(
		0 => '--',
		1 => '文本格式'
	...
	array(
		0 => '我能新增自己的標籤嗎?',
		1 => '當然可以--如果您是這個討論區的管理員並且擁有正確的權限, 您可以通過自定義BBCode新增更多的BBCodes.'
	)
);
