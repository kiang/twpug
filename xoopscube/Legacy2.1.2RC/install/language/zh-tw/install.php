...
define('_INSTALL_L70', '請先確定mainfile.php 這個檔案的屬性是可讀寫的，以便讓程式把必要的資訊寫入（例如！在 UNIX/LINUX 主機上 chmod 777 mainfile.php ，於WinOS 系統上則把唯讀屬性去除）。當您完成這個動作時請按重新整理按鈕。');
...
define('_INSTALL_L16', '%s 是您的資料庫主機位置');
define('_INSTALL_L17', '%s 是您的資料庫使用者名稱');
define('_INSTALL_L18', '%s 是您的資料庫使用者密碼');
define('_INSTALL_L19', '%s 是您要安裝 XOOPS Cube 所建立的新資料庫名稱');
define('_INSTALL_L20', '%s 是在資料表前會加上一個識別名稱，尤其是您在同一資料庫安裝多個程式時，請注意不要跟其他程式，如 *Nuke等重複，以免發生錯誤');
...
define('_INSTALL_L133', '%s 資料表升級成功。');
define('_INSTALL_L134', '%s 資料表升級失敗.');
define('_INSTALL_L135', '資料表升級失敗。');
define('_INSTALL_L136', '資料表升級成功。');
...
define('_INSTALL_L149', '安裝升級精靈將您的新聞評論升級到XOOPS Cube.<br />請耐心等候.');
define('_INSTALL_L150', '安裝升級精靈將您的表情符號及評分系統圖案升級到XOOPS Cube.<br />請耐心等候。');
define('_INSTALL_L151', '安裝升級精靈將你大頭貼圖片升級到XOOPS Cube.<br />請耐心等候。');
