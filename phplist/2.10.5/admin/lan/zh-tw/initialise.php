...
$lan = array (
  ...
  'subscribe to the announcements list' => '訂閱公告電子報',
  'to make sure you are updated when new versions come out.
    Sometimes security bugs are found which make it important to upgrade. Traffic on the list is very low.' => '來確認您可以在最新版本推出時即時更新，在安全性問題發現時，升級的工作就變的重要許多；這個電子報的訊息頻率並不高。',
  'Continue with' => '繼續',
  'PHPlist Setup' => '安裝',
