<?php
	...
	$traditionalChinese = array(
		 ...
		 */
			...
			'item:object:reported_content' => '舉報項目',
			'reportedcontent' => '舉報內容',
			'reportedcontent:this' => '舉報',
			'reportedcontent:none' => '沒有任何舉報',
			...
			'reportedcontent:objecturl' => '物件網址',
			'reportedcontent:reason' => '理由',
			'reportedcontent:description' => '為什麼您希望我們處理這個項目？',
			'reportedcontent:address' => '項目位置',
			'reportedcontent:success' => '您的舉報已經寄發給管理者',
			'reportedcontent:failing' => '您的舉報無法送出',
