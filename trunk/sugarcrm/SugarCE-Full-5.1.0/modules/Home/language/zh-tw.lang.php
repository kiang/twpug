<?php
  ...
  *********************************************************************************/
  /*********************************************************************************
  * $Header: modules/Home/language/zh-tw.lang.php, 20080513 Mon 16/06/08 21:46:20 
...
$mod_strings = array ( 
   ...
   'LBL_RELOAD_PAGE' => '請 <a href="javascript: window.location.reload()">重新整理視窗</a> 來使用這個儀表物件。' ,
   ...
   'LBL_CHARTS' => '圖表' ,
   'LBL_TOOLS' => '工具' ,
   'LBL_MAX_DASHLETS_REACHED' => '您使用了管理者設定的儀表物件數量上限，接下來要新增前得先移除幾個。' ,
   ...
   'LBL_DASHLET_DELETE' => '刪除儀表物件' ,
   'LBL_DASHLET_REFRESH' => '重新整理儀表物件' ,
   'LBL_DASHLET_EDIT' => '編輯儀表物件' ,
   'LBL_TRAINING_TITLE' => '訓練' ,
   'LBL_CREATING_NEW_PAGE' => '建立新頁面中' ,
   'LBL_NEW_PAGE_FEEDBACK' => '您已經建立了一個新頁面，接著可以透過新增儀表物件選單項目來加入內容。' ,
   ...
   'LBL_SOURCE_RECAPTCHA' => 'reCAPTCHA 協助避免自動程式濫用您的網站資源（像是評論廣告或惡意註冊），透過使用 CAPTCHA 來確認操作的是實際的人。' ,
