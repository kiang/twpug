...
define('TEXT_PRODUCTS_RECORD_ARTIST', '歌手：');
define('TEXT_PRODUCTS_RECORD_COMPANY', '唱片公司：');
define('TEXT_PRODUCTS_MUSIC_GENRE', '音樂類型：');
...
define('TEXT_PRODUCT_DATE_AVAILABLE', '這產品將會有在庫，日期在 %s.');
...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', '特價，產品/下載 組合，需要送運地址');
define('TEXT_PRODUCTS_SORT_ORDER', '排序:');

define('TEXT_PRODUCTS_QTY_BOX_STATUS_ON', '是的，顯示 -數量框盒');
define('TEXT_PRODUCTS_QTY_BOX_STATUS_OFF', '否的，不顯示 -數量框盒');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_MEDIA_MANAGER','複製任何與此產品有關聯的 - 媒體管理員專輯。');
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT','0 = 沒有限制, 1 = 沒有數量框盒');
