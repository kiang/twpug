...
define('BUTTON_CREATE_ACCOUNT_ALT', '註冊');
define('BUTTON_LOG_OFF_ALT', '登出');
define('BUTTON_ADD_TO_CART_ALT', '把這加入我的購物車');
define('BUTTON_ADD_ADDRESS_ALT', '加入地址');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT', '把所選產品，加入購物車');
define('BUTTON_BACK_ALT', '返回');
define('BUTTON_BUY_NOW_ALT', '馬上購買');
define('BUTTON_CANCEL_ALT', '取消');
define('BUTTON_CHANGE_ADDRESS_ALT', '更改地址');
define('BUTTON_CHECKOUT_ALT', '結帳');
define('BUTTON_CONFIRM_SEND_ALT', '送出禮品券');
define('BUTTON_CONFIRM_ORDER_ALT', '確認訂單');
define('BUTTON_CONTINUE_ALT', '繼續');
define('BUTTON_CONTINUE_SHOPPING_ALT', '繼續購物');
define('BUTTON_DELETE_ALT', '移除');
define('BUTTON_DELETE_SMALL_ALT', '刪除');
define('BUTTON_DOWNLOAD_ALT', '立即下載');
define('BUTTON_EDIT_SMALL_ALT', '編輯');
define('BUTTON_IN_CART_ALT', '加入購物車');
define('BUTTON_LOGIN_ALT', '登錄');
define('BUTTON_NEXT_ALT', '向後');
define('BUTTON_PREVIOUS_ALT', '向前');
define('BUTTON_REDEEM_ALT', '兌換');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', '返回產品列表');
define('BUTTON_REVIEWS_ALT', '前去評論頁');
define('BUTTON_SEARCH_ALT', '搜尋');
define('BUTTON_SEND_ALT', '立即送出');
define('BUTTON_SEND_ANOTHER_ALT', '送出另一禮品券');
define('BUTTON_SEND_A_GIFT_CERT_ALT', '送出禮品券');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', '運費估計');
define('BUTTON_SOLD_OUT_ALT', '產品售完');
define('BUTTON_SOLD_OUT_SMALL_ALT', '產品售完');
define('BUTTON_SUBMIT_ALT', '送出資料');
define('BUTTON_TELL_A_FRIEND_ALT', '推薦給親友');
define('BUTTON_TELLAFRIEND_ALT', '推薦給親友');
define('BUTTON_UNSUBSCRIBE', '停訂');
define('BUTTON_UPDATE_ALT', '更新');
define('BUTTON_VIEW_SMALL_ALT', '觀看');
define('BUTTON_WRITE_REVIEW_ALT', '撰寫產品評論');
define('BUTTON_READ_REVIEWS_ALT', '閱讀產品評論');
define('BUTTON_GOTO_PROD_DETAILS_ALT', '前去這產品詳細資料');
define('BUTTON_MORE_REVIEWS_ALT', '閱讀更多評論');
?>