...
$lang = array_merge($lang, array(
	...
	'EDIT_MODULE'			=> '編輯模組',
	'EDIT_MODULE_EXPLAIN'	=> '這裡您可以輸入模組特有設定',
	...
	'MODULE_DISPLAYED_EXPLAIN'	=> '如果您不希望顯示這個模組又想使用它, 設定為否.',
	'MODULE_EDITED'				=> '模組編輯完成.',
	'MODULE_ENABLED'			=> '模組啟用',
	'MODULE_LANGNAME'			=> '模組語言名稱',
	'MODULE_LANGNAME_EXPLAIN'	=> '輸入顯示的模組名稱. 如果語言由語言檔案提供請使用語言常數.',
	'MODULE_TYPE'				=> '模組類型',
