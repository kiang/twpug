...
$lang = array_merge($lang, array(
	...
	'ACL_NEVER'				=> '從不',
	'ACL_SET'				=> '權限設定',
	'ACL_SET_EXPLAIN'		=> '權限基於簡單的 <samp>是</samp>/<samp>否</samp> 系統. 設定群組和會員選項為 <samp>從不</samp> 將覆蓋其他設定的值. 如果您不希望給這個會員或群組設定值, 請選擇 <samp>否</samp>. 如果值在其他地方設定, 他們將在設定中使用, 否則請選擇 <samp>從不</samp>. 所有選中的對象 (他們前面的勾選框) 將複製您設定的權限組.',
	'ACL_SETTING'			=> '設定',
	...
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> '這裡您可以檢視給選中的會員/組設定的有效管理權限',
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS_EXPLAIN'	=> '這裡您可以檢視給選中的會員/組設定的有效版主權限',
	'ACP_VIEW_FORUM_PERMISSIONS_EXPLAIN'		=> '這裡您可以檢視給選中的會員/組和版面設定的有效版面權限',
	'ACP_VIEW_FORUM_MOD_PERMISSIONS_EXPLAIN'	=> '這裡您可以檢視給選中的會員/組和版面設定的版主權限',
	'ACP_VIEW_USER_PERMISSIONS_EXPLAIN'			=> '這裡您可以檢視給選中的會員/組設定的有效會員權限',
	...
	'APPLY_PERMISSIONS_EXPLAIN'	=> '為這個對象設定的權限和角色將只被應用到這個對象和所有選中的對象.',
	'AUTH_UPDATED'				=> '權限更新完成.',
	...
	'NO_ROLE_SELECTED'			=> '沒有選中的角色.',
	'NO_USER_GROUP_SELECTED'	=> '您沒有選中會員或組.',

	'ONLY_FORUM_DEFINED'	=> '您只設定了選中的版面, 請再選中至少一個會員或群組.',

	'PERMISSION_APPLIED_TO_ALL'		=> '權限和角色也將被應用到選中的對象上',
	'PLUS_SUBFORUMS'				=> '+子版面',
	...
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> '可以使用部分版面功能, 但是不能發表附件和使用主題圖標.',
	'ROLE_DESCRIPTION_FORUM_LIMITED_POLLS'	=> '和受限瀏覽一樣但是可以建立投票.',
	'ROLE_DESCRIPTION_FORUM_NOACCESS'		=> '無法看見和瀏覽版面.',
	'ROLE_DESCRIPTION_FORUM_ONQUEUE'		=> '可以使用大多數的版面功能包括發表附件, 但是文章和主題需要版主審閱後才能發表.',
	'ROLE_DESCRIPTION_FORUM_POLLS'			=> '和標準瀏覽一樣但是可以建立投票.',
	'ROLE_DESCRIPTION_FORUM_READONLY'		=> '可以瀏覽版面, 但是不能建立也不能回覆主題.',
	'ROLE_DESCRIPTION_FORUM_STANDARD'		=> '可以使用大多數討論區功能包括發表附件, 但是不能鎖定和刪除自己的主題, 也不能建立投票.',
	...
	'ROLE_DESCRIPTION_USER_LIMITED'			=> '可以瀏覽部分會員功能. 但是不允許發表附件, 發送email和私人簡訊.',
	...
	'ROLE_DESCRIPTION_EXPLAIN'		=> '您可以輸入一個簡短的說明, 以解釋這個角色的用途和意義. 您這裡輸入的文字也會顯示在權限界面上.',
	...
	'SELECTED_FORUM_NOT_EXIST'		=> '選中的版面不存在.',
	'SELECTED_GROUP_NOT_EXIST'		=> '選中的組不存在.',
	'SELECTED_USER_NOT_EXIST'		=> '選中的會員不存在.',
	'SELECT_FORUM_SUBFORUM_EXPLAIN'	=> '您選中的版面將包含所有的子版面',
	'SELECT_ROLE'					=> '選擇角色…',
	'SELECT_TYPE'					=> '選擇類型',
	...
	'USER_IS_MEMBER_OF_CUSTOM'		=> '是下列自定義組的成員',
