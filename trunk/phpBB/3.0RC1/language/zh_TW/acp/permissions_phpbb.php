...
$lang = array_merge($lang, array(
	...
	'acl_u_sendpm'		=> array('lang' => '可以發送私人簡訊', 'cat' => 'pm'),
	'acl_u_masspm'		=> array('lang' => '可以群發簡訊', 'cat' => 'pm'),
	'acl_u_readpm'		=> array('lang' => '可以閱讀私人簡訊', 'cat' => 'pm'),
	'acl_u_pm_edit'		=> array('lang' => '可以編輯自己的私人簡訊', 'cat' => 'pm'),
	'acl_u_pm_delete'	=> array('lang' => '可以刪除自己的私人簡訊', 'cat' => 'pm'),
	...
	'acl_u_hideonline'	=> array('lang' => '可以隱藏在線上狀態', 'cat' => 'misc'),
	'acl_u_viewonline'	=> array('lang' => '可以檢視在線上情況', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_print'		=> array('lang' => '可以打印主題', 'cat' => 'actions'),
	...
	'acl_f_postcount'	=> array('lang' => '增加文章數<br /><em>請注意這個設定只對新文章子有效.</em>', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_m_ban'		=> array('lang' => '可以管理停用', 'cat' => 'misc'), // This moderator setting is only global (and not local)
));
...
$lang = array_merge($lang, array(
	...
	'acl_a_forumadd'	=> array('lang' => '可以新增新版面', 'cat' => 'forums'),
	...
	'acl_a_viewauth'	=> array('lang' => '可以檢視權限掩碼', 'cat' => 'permissions'),
	'acl_a_authgroups'	=> array('lang' => '可以修改單獨的組權限', 'cat' => 'permissions'),
