...
$lang = array_merge($lang, array(
	...
	'BOT_DELETED'		=> '機器人刪除完成.',
	'BOT_EDIT'			=> '編輯機器人',
	'BOT_EDIT_EXPLAIN'	=> '這裡您可以增加或修改目前的機器人項目. 您可以設定一個機構字元串和/或多個IP位址(或者位址範圍)來符合. 當設定符合字元串時要小心. 您也可以指定機器人瀏覽時看到的介面和語言. 設定一個簡單的介面可以減少機器人使用的帶寬. 記住給機器人群組設定合適的權限.',
	'BOT_LANG'			=> '機器人語言',
	'BOT_LANG_EXPLAIN'	=> '當機器人瀏覽時顯示的語言.',
	'BOT_LAST_VISIT'	=> '最後瀏覽',
	'BOT_IP'			=> '機器人IP位址',
	'BOT_IP_EXPLAIN'	=> '允許局部符合, 用英文逗號區分多個位址.',
	'BOT_NAME'			=> '機器人名稱',
	'BOT_NAME_EXPLAIN'	=> '僅用於您對機器人的稱呼.',
	'BOT_NEVER'			=> '從未',
	'BOT_STYLE'			=> '機器人介面',
	'BOT_STYLE_EXPLAIN'	=> '當機器人瀏覽時顯示的介面.',
	'BOT_UPDATED'		=> '機器人更新完成.',
	'BOT_VIS'			=> '機器人可見',
	'BOT_VIS_EXPLAIN'	=> '允許在會員在線上列表中顯示機器人.',

	'ERR_BOT_AGENT_MATCHES_UA'	=> '您提供的機器人機構和您現在使用的很相似. 請調整這個機器人的機構.',
	'ERR_BOT_NO_IP'				=> '您提供的IP位址或主機名是無效的.',
	'ERR_BOT_NO_MATCHES'		=> '您必須為這個機器人提供至少一個符合的機構或IP位址.',
