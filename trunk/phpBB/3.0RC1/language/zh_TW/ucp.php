...
$lang = array_merge($lang, array(
	...
	<br />
	您同意不張貼任何帶有辱罵，淫穢，粗俗，誹謗，仇恨，威脅，色情的內容，不張貼任何帶有侵犯您所在國家的法律， 「%1$s」 所在國家的法律，國際公法的內容。以上的行為可能會使您在未得到通知的情況下被永遠禁止瀏覽這個討論區。所有文章發表所使用的 IP 地址將被記錄，以協助調查違反條款的事件。您同意 「%1$s」 具有在任何我們認為合適的時候刪除，修改，移動，或關閉任何話題的權力。作為一個會員，您同意您所輸入的任何資訊將被記錄至資料庫。在沒有得到您同意的前提下我們不會向任何第三方發佈這些資訊，但是 「%1$s」 和 phpBB 不能為任何因為黑客行為導致的資料洩漏承擔法律責任.
	',
	...
	<br />
	您的資訊通過兩種方式產生. 首先, 通過瀏覽 「%1$s」 將使 phpBB 軟體在您的電腦中產生一定數量的 cookie 檔案, 這些 cookie 是瀏覽器用於快取資訊的臨時檔案. 其中有兩個 cookie 包含會員的ID資訊 (下文指代 「會員ID」) 和一個匿名的會員對話ID (下文中指代 「對話ID」), 將被 phpBB 軟體指派自動產生. 第三個cookie 將在您瀏覽 「%1$s」 中的主題後自動產生, 用於存儲您的瀏覽歷史資訊, 用於提高會員體驗.<br />
	<br />
	phpBB軟體在瀏覽 「%1$s」 的同時建立外部cookie, 雖然這已經超出了本文件的範圍, 其目的只是在覆蓋一個 phpBB 軟體建立的頁面. 第二種是我們通過您在軟體中提供的內容收集到的您的資訊. 這種情況是但是不局限於: 以匿名會員發帖 (下文中指代 「匿名文章」), 在 「%1$s」 上註冊帳號 (下文中指代 「您的帳號」) 登入動作和您在註冊後發表的文章 (下文中指代 「您的文章」).<br />
	<br />
	您的帳號將至少包含一個唯一的帳號 (下文中指代 「您的帳號」), 一個用於登入您的帳號的個人密碼 (下文中指代 「您的密碼」) 和一個個人的, 有效的 email 地址 (下文中指代 「您的 email」). 您在 「%1$s」 上的帳號所包含的資訊將受到我們的主機所在國家的資料保護法律的保護. 除了您的帳號和您的密碼以及在註冊過程中 「%1$s」 要求的email地址以外, 您的其他任何資訊都是可用的(除了軟體使用者的特殊要求). 在任何情況下, 您可以選擇您的資訊是否被公開. 此外, 在您的帳號中, 您可以選擇定向收發 phpBB 軟體自動產生的email.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ATTACHMENTS_EXPLAIN'			=> '這是您在討論區中發表的附件列表。',
	'ATTACHMENTS_DELETED'			=> '成功刪除數個附件。',
	'ATTACHMENT_DELETED'			=> '成功刪除附件。',
	'AVATAR_CATEGORY'				=> '分類',
	'AVATAR_EXPLAIN'				=> '最大尺寸：寬 %1$d 象素，高 %2$d 象素，檔案大小 %3$dkB。',
	...
	'BOARD_TIMEZONE'			=> '我的時區',
	'BOOKMARKS'					=> '收藏夾',
	'BOOKMARKS_EXPLAIN'			=> '您可以收藏主題以方便將來搜尋。如果需要刪除其中的項目請選中勾選框，然後點選 <em>刪除選中項目</em> 按鈕。',
	...
	'CONFIRM_EMAIL_EXPLAIN'		=> '如果您在修改email地址，您需要填入這項內容。',
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> '如果您希望修改密碼，email地址或者帳號，您必須確認您目前的密碼。',
	...
	'DELETE_ATTACHMENTS'		=> '刪除附件',
	'DELETE_ATTACHMENT_CONFIRM'	=> '您確認刪除這個附件嗎？',
	'DELETE_ATTACHMENTS_CONFIRM'=> '您確認刪除這些附件嗎？',
	'DELETE_AVATAR'				=> '刪除圖片',
	'DELETE_COOKIES_CONFIRM'	=> '您確認刪除本討論區的所有cookie嗎？',
	'DELETE_MARKED_PM'			=> '刪除選中的簡訊',
	'DELETE_MARKED_PM_CONFIRM'	=> '您確認刪除所有選中的簡訊嗎？',
	...
	'DOWNLOADS'					=> '下載',
	'DRAFTS_DELETED'			=> '所有選中的草稿已經被刪除。',
	'DRAFTS_EXPLAIN'			=> '這裡可以檢視，編輯和刪除您儲存的草稿。',
	'DRAFT_UPDATED'				=> '草稿已經更新。',

	'EDIT_DRAFT_EXPLAIN'		=> '這裡您可以編輯您的草稿。草稿不能包含附件和投票。',
	'EMAIL_BANNED_EMAIL'		=> '您輸入的 email 地址不允許使用。',
	'EMAIL_INVALID_EMAIL'		=> '您輸入的 email 地址無效。',
	'EMAIL_REMIND'				=> '這必須是您在註冊時提供的 email 地址。',
	'EMAIL_TAKEN_EMAIL'			=> '您輸入的 email 地址已經被使用',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'=> '輸入包含您的圖示的遠端連結地址。',
	...
	'MAX_FOLDER_REACHED'			=> '達到最大會員允許自定義資料夾數目',
	'MESSAGE_BY_AUTHOR'				=> '由',
	...
	'NEW_EMAIL_ERROR'				=> '您輸入的 email 地址不符合。',
	...
	'PASSWORD_UPDATED'			=> '您的密碼已經發送到您的原始email地址。',
	'PERMISSIONS_RESTORED'		=> '成功回覆原權限。',
	'PERMISSIONS_TRANSFERRED'	=> '成功轉換權限自 <strong>%s</strong>，您現在可以使用會員權限瀏覽版面.<br />請注意管理員權限不會被轉換。您可以在任何時候恢復回原權限。',
	...
	'REMOVE_ADDRESS'					=> '刪除地址',
	'REMOVE_SELECTED_BOOKMARKS'			=> '刪除選中的書籤',
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> '您確認要刪除所有選中的書籤嗎？',
	...
	'UCP'						=> '會員控制面板',
	'UCP_ACTIVATE'				=> '啟用帳號',
	'UCP_ADMIN_ACTIVATE'		=> '請注意在帳號啟用前您必須輸入一個有效的 Email 地址，管理員將審核您的帳號，如果審核通過將會發送通知郵件到您提供的 Email 地址。',
	'UCP_AIM'					=> 'AIM 帳戶',
	'UCP_ATTACHMENTS'			=> '附件',
	'UCP_COPPA_BEFORE'			=> '早於 %s',
	'UCP_COPPA_ON_AFTER'		=> '晚於 %s',
	'UCP_EMAIL_ACTIVATE'		=> '請注意在帳號啟用前您必須輸入一個有效的 Email 地址。通過這個 Email 地址您將收到包含帳號啟用連結的郵件。',
	'UCP_ICQ'					=> 'ICQ 號碼',
	...
	'UCP_NO_ATTACHMENTS'		=> '您沒有發表的附件',

	'UCP_PREFS'					=> '討論區相關參數',
	'UCP_PREFS_PERSONAL'		=> '編輯全局設定',
	'UCP_PREFS_POST'			=> '編輯發帖設定',
	...
	'UCP_REMIND'					=> '發送密碼',
	'UCP_RESEND'					=> '發送啟用郵件',
	'UCP_WELCOME'					=> '歡迎來到會員控制面板。這裡您可以監視，檢視和更新您的資料，參數，訂閱版面和主題。您還可以給其他會員發送簡訊 (如果允許)。在繼續下一步操作前請確認您已經仔細閱讀了所有的公告。',
	'UCP_YIM'						=> 'Yahoo Messenger',
	'UCP_ZEBRA'						=> '好友與黑名單',
	'UCP_ZEBRA_FOES'				=> '管理黑名單',
	'UCP_ZEBRA_FRIENDS'				=> '管理好友列表',
	'UNKNOWN_FOLDER'				=> '未知資料夾',
	'UNWATCH_MARKED'				=> '取消訂閱選中',
	...
	'WATCHED_EXPLAIN'			=> '以下是您訂閱的版面和主題列表。您將收到它們的更新資訊。取消訂閱: 選中版面或主題後點選 <em>取消訂閱選中</em> 按鈕。',
	'WATCHED_FORUMS'			=> '觀察的版面',
	'WATCHED_TOPICS'			=> '觀察的主題',
	'WRONG_ACTIVATION'			=> '您提供的啟用碼在資料庫中找不到符合的記錄',

	'YOUR_DETAILS'				=> '您的資訊',
	'YOUR_FOES'					=> '您的黑名單',
	'YOUR_FOES_EXPLAIN'			=> '刪除帳號: 選中並點選提供',
	'YOUR_FRIENDS'				=> '您的好友',
	'YOUR_FRIENDS_EXPLAIN'		=> '刪除帳號: 選中並點選提供',
