...
$lang = array_merge($lang, array(
	...
	'REPORT_MESSAGE_EXPLAIN'	=> '使用這個資料表來向討論區管理員舉報勾選的內容. 舉報一般用於違反討論區規則的情況.',
	'REPORT_NOTIFY'				=> '通知您',
	...
	'RETURN_NEW_FORUM'			=> '%s返回至新討論區%s',
	'RETURN_NEW_TOPIC'			=> '%s返回至新文章子%s',
	'RETURN_POST'				=> '%s返回文章%s',
	'RETURN_QUEUE'				=> '%s返回隊列%s',
	...
	'SPLIT_TOPIC_EXPLAIN'				=> '使用下面的資料表您可以將一個主題分割為兩個, 可以分割勾選文章也可以分割未勾選的文章',
	...
	'UNAPPROVED_POSTS_TOTAL'		=> '目前共有 <strong>%d</strong> 篇文章等待核准發佈',
	'UNAPPROVED_POSTS_ZERO_TOTAL'	=> '目前沒有等待核准發佈的文章',
	'UNAPPROVED_POST_TOTAL'			=> '目前共有 <strong>1</strong> 篇文章等待核准發佈',
	'UNLOCK'						=> '解鎖',
	'UNLOCK_POST'					=> '解鎖文章',
