...
$mod_strings = array (
  'DESC_MODULES_INSTALLED' => '已經安裝了下面模組：',
  'DESC_MODULES_QUEUED' => '在本機上找到要安裝的模組：',
  ...
  'ERR_UW_FILE_NOT_DELETED' => '移除軟體時發生錯誤',
  ...
  'ERR_UW_NO_FILE_UPLOADED' => '請指定一個檔案後重試！<br>\n',
  'ERR_UW_NO_FILES' => '找不到要檢查的檔案，發生錯誤。',
  'ERR_UW_NO_MANIFEST' => '壓縮檔案中不包含 manifest.php 設定檔，無法處理。',
  'ERR_UW_NO_VIEW' => '指定的檢視有誤。',
  'ERR_UW_NO_VIEW2' => '沒有定義檢視，請到管理者首頁來導引這個頁面。',
  'ERR_UW_NOT_VALID_UPLOAD' => '上傳失敗。',
  'ERR_UW_NO_CREATE_TMP_DIR' => '無法建立暫存資料夾，請檢查檔案權限。',
  'ERR_UW_ONLY_PATCHES' => '您只能夠透過這個頁面上傳修補程式。',
  'ERR_UW_PREFLIGHT_ERRORS' => '事前檢查時發現錯誤',
  'ERR_UW_UPLOAD_ERR' => '上傳檔案失敗，請重試！<br>\n',
  ...
  'LBL_BUTTON_DELETE' => '刪除軟體',
  'LBL_BUTTON_DONE' => '完成',
  'LBL_BUTTON_INSTALL' => '升級前測試',
  'LBL_BUTTON_NEXT' => '下一頁',
  'LBL_BUTTON_RECHECK' => '重新檢查',
  'LBL_UPLOAD_UPGRADE' => '上傳一個升級檔案：',
