...
$mod_strings = array (
  ...
  'ShowLoggedInUserCount' => 'Active Users Count',
  ...
  'LBL_TRACKER_QUERIES_DESC' => 'Track SQL statements when dump_slow_queries is enabled and query execution time is below the slow_query_time_msec value',
  ...
  'LBL_TRACKER_PERF_DESC' => 'Track performance metrics (database, file and memory usage)',
  'LBL_TRACKER_PERF_HELP' => 'Track database roundtrips, files accessed and memory usage',
  'LBL_TRACKER_SESSIONS_DESC' => 'Track user\'s session information',
  'LBL_TRACKER_SESSIONS_HELP' => 'Track active users and users&rsquo; session information',
  'LBL_TRACKER_DESC' => 'Track user\'s actions',
