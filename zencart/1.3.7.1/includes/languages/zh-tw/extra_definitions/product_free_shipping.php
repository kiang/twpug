...
//define('TEXT_PRODUCT_FREE_SHIPPING_ICON', '免費送貨'); // for text or set to '' for nothing
define('TEXT_PRODUCT_FREE_SHIPPING_ICON', zen_image(DIR_WS_TEMPLATE_IMAGES . 'always-free-shipping.gif', '經常免費送貨')); // for an image or comment out to use another
?>