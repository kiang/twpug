 ...
 */
  ...
  if (IS_ADMIN_FLAG === true) {
    define('MODULE_PAYMENT_PAYPALWPP_TEXT_ADMIN_DESCRIPTION', '<strong>PayPal Express Checkout</strong>%s<br />\' . (substr(MODULE_PAYMENT_PAYPALWPP_MODULE_MODE,0,7) == \'Payflow\' ? \'<a href="https:
...
// EC buttons -- Do not change these values:
  define('MODULE_PAYMENT_PAYPALWPP_EC_BUTTON_IMG', 'https:
  define(\'MODULE_PAYMENT_PAYPALWPP_EC_BUTTON_SM_IMG\', \'https:
  define(\'MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_IMG\', \'https:
