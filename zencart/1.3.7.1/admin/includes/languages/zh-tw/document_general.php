...
define('TEXT_DOCUMENT_STATUS', '文件狀態：');
...
define('TEXT_DOCUMENT_DATE_AVAILABLE', '上市日期：');
define('TEXT_DOCUMENT_AVAILABLE', '有貨');
define('TEXT_DOCUMENT_NOT_AVAILABLE', '缺貨');
...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', '特價，產品/下載 組合需要一個貨運地址');
...
define('TEXT_DOCUMENT_NAME', '文件名稱:');
define('TEXT_DOCUMENT_DETAILS', '文件內容:');
define('TEXT_DOCUMENT_IMAGE', '文件圖像:');
define('TEXT_DOCUMENT_IMAGE_DIR', '上載到資料夾：');
define('TEXT_DOCUMENT_URL', '文件 URL:');
define('TEXT_DOCUMENT_URL_WITHOUT_HTTP', '<small>(不用加 http://)</small>');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_PRODUCTS_ATTRIBUTES_INFO','屬性功能為：');
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT','0 = 沒有限制。  1 = 沒有數量盒');
...
// meta tags
  define('TEXT_META_TAG_TITLE_INCLUDES','<strong>標誌那一些文件的後設標籤標題 Meta Tag Title 應該包括在內：</strong>');
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>文件名稱：</strong>');
